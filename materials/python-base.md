...
In this page we give an example of creating an environment with JupyterLab, which gives you a popular notebook interface for coding and data analysis.
...
- Create a new environment, which we will call `demo` (you may give your environment a name of your choice):
...
- Install JupyterLab (for notebook interface):
    ...
    ```bash
    mamba install -y -n demo jupyterlab
    ```
